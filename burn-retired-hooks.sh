...
# scope confirmed via interview: retired cluster + coord-own/guard-coord-ownership.
#
...
rm -rfv "$HOME/.claude/agents/mesh-fan-out"
...
rm -rfv "$SRC/dot_claude/agents/mesh-fan-out"
